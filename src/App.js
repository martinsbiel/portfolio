  ...
  return (
    <Container>
        <div className="col-md-3 default-bg">
            ...
            <p className="text-white about">Tenho 25 anos, nasci em Joinville, mas já morei no interior de SP. A única coisa que nunca mudou é meu interesse desde sempre por tecnologia. Encontrei na tecnologia a oportunidade de estar em constante desafio.</p>
        ...
        <div className="col-md-6 default-bg">
            ...
            <p className="text-white">Possuo fortes conhecimentos em: PHP, Laravel, JavaScript ES6+, jQuery, Bootstrap e MySQL.</p>
        ...
        <Modal id="notesModal" name="Notes" year="2021" link="https://github.com/martinsbiel/notes" linkText="Link para o repositório do projeto, contribua." content="Sistema de controle de notas/lembretes. Crie, gerencie e exporte suas notas em um sistema muito completo. Utilizei Laravel para a API REST com autenticação JWT e por sessão no back-end e VueJS para deixar o front-end mais dinâmico em conjunto com Bootstrap. Contém recurso de exportar notas para Excel e PDF, registro de logs em todos os endpoints da API de notas e sistema de login completo. Também implementei Design Pattern Repository e testei todos os endpoints da API utilizando PHPUnit. Código fonte disponível no repositório do projeto, toda contribuição é bem-vinda.">
